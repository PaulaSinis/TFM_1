...
Param <- c( "q","sdhet2","sdsp2","beta1", "Pbeta1", "R", "Pexceso")
...
min(Resul_BYM_Cov2$summary[1:547,9]) 

# Resumen de los resultados
Resul_BYM_Cov2$summary[1:5,]

P_Cov2 <- Resul_BYM_Cov2$summary[6:547,1]
P_Cov2 <- as.data.frame(P_Cov2)
#write_xlsx(P_Cov2,"../results/P_Cov2.xlsx" )

Exceso_Cov2 <- Resul_BYM_Cov2$summary[548:1089,1]
Exceso_Cov2 <- as.data.frame(Exceso_Cov2)
#write_xlsx(Exceso_Cov2,"../results/Exceso_Cov2.xlsx" )

Resul_BYM_Cov2 <- as.data.frame(round(Resul_BYM_Cov2$summary[1:5,],2))
#write_xlsx(Resul_BYM_Cov2,"../results/Resultados_BYM_Cov2.xlsx" )
